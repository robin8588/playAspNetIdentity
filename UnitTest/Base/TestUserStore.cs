...
namespace UnitTest.Base
{
    public class TestUserStore : IUserStore<ApplicationUser>, IUserLoginStore<ApplicationUser>, IUserRoleStore<ApplicationUser>, IUserClaimStore<ApplicationUser>, IUserPasswordStore<ApplicationUser>, IUserSecurityStampStore<ApplicationUser>
    {
        ...
        public TestUserStore()
        {
            ...
            {
                { "TestUser1", new ApplicationUser {UserNameType=UserNameType.Email, UserName="Sharon", Id="15e8cda1-3ea3-473d-902f-b62aa55816db"}},
                { "TestUser2", new ApplicationUser {UserNameType=UserNameType.Phone, UserName="adarsh", Id="67e6yda1-3ea3-473d-902f-b62er55816db"}},
                { "TestUser3", new ApplicationUser {UserNameType=UserNameType.UserName,  UserName="Shiju",  Id="78e5fda1-3ea3-473d-902f-b62aa86716db"}}
            };
